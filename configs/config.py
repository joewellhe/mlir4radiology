...
parser.add_argument('--dataset', type=str, default='iu-xra', help="iu-xray or mimic-cxr")
parser.add_argument('--annotation', type=str, default=r'/home/users/h/hej/dataset/iu_xray/annotation.json', help="annotation file of the dataset")
parser.add_argument('--base_dir', type=str, default=r'/home/users/h/hej/dataset/iu_xray/images', help="base dir to help find images")
